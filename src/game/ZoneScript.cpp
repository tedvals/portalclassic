...
OPvPCapturePoint::OPvPCapturePoint(OutdoorPvP * pvp):
    ...
    m_value(0), m_team(TEAM_INDEX_NEUTRAL), m_OldState(OBJECTIVESTATE_NEUTRAL),
...
void ZoneScript::TeamCastSpell(PvpTeamIndex team, int32 spellId)
{
    if (spellId > 0)
...
void ZoneScript::TeamApplyBuff(PvpTeamIndex team, uint32 spellId, uint32 spellId2)
{
