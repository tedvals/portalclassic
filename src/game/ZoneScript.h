...
class OPvPCapturePoint
{
    public:
        ...
        virtual void ChangeTeam(PvpTeamIndex /*oldTeam*/) {}
...
class ZoneScript
{
    ...
    public:
        ...
        void TeamApplyBuff(PvpTeamIndex team, uint32 spellId, uint32 spellId2 = 0);
    ...
    protected:
        ...
        void TeamCastSpell(PvpTeamIndex team, int32 spellId);
};
