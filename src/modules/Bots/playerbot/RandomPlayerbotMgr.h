...
class RandomPlayerbotMgr1 : public PlayerbotHolder
{
    public:
        RandomPlayerbotMgr1();
        virtual ~RandomPlayerbotMgr1();
        static RandomPlayerbotMgr1& instance()
        {
            static RandomPlayerbotMgr1 instance;
            return instance;
        }
...
#define sRandomPlayerbotMgr1 RandomPlayerbotMgr1::instance()
