...
void AddSC_dun_morogh()
{
    ...
    pNewScript->Name = "npc_mortar_team_watcher";
    pNewScript->GetAI = &GetAI_npc_mortar_team_watcher;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_angus";
    pNewScript->GetAI = &GetAI_npc_angus;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_shorty";
    pNewScript->GetAI = &GetAI_npc_shorty;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_rifleman_wheeler";
    pNewScript->GetAI = &GetAI_npc_rifleman_wheeler;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_rifleman_middlecamp";
    pNewScript->GetAI = &GetAI_npc_rifleman_middlecamp;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_spotter_klemmy";
    pNewScript->GetAI = &GetAI_npc_spotter_klemmy;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "go_mortar";
    pNewScript->GOGetAI = &GetAI_go_mortar;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_mortar_team_target_dummy";
    pNewScript->GetAI = &GetAI_npc_mortar_team_target_dummy;
    pNewScript->RegisterSelf();
}
