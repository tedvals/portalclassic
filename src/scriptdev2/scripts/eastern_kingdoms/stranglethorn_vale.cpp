...
void AddSC_stranglethorn_vale()
{
    ...
    pNewScript = new Script;
    pNewScript->Name = "mob_assistant_kryll";
    pNewScript->GetAI = &GetAI_mob_assistant_kryll;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "go_transpolyporter";
    pNewScript->GOGetAI = &GetAIgo_transpolyporter;
    //pNewScript->pGOHello = &GOHello_go_transpolyporter;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_molthor";
    pNewScript->GetAI = &GetAI_npc_molthor;
    pNewScript->pQuestRewardedNPC = &QuestComplete_npc_molthor;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_heart_of_hakkar";
    pNewScript->GetAI = &GetAI_npc_heart_of_hakkar;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_servant_of_the_hand";
    pNewScript->GetAI = &GetAI_npc_servant_of_the_hand;
    pNewScript->RegisterSelf();
    ...
    pNewScript = new Script;
    pNewScript->Name = "npc_witch_doctor_unbagwa";
    pNewScript->GetAI = &GetAI_npc_witch_doctor_unbagwa;
    pNewScript->pQuestRewardedNPC = QuestRewarded_npc_witch_doctor_unbagwa;
    pNewScript->RegisterSelf();
