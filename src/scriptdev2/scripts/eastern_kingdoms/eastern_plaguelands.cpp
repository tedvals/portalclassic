...
void AddSC_eastern_plaguelands()
{
    ...
    pNewScript = new Script;
    pNewScript->Name = "npc_eris_havenfire_peasant";
    pNewScript->GetAI = &GetAI_npc_eris_havenfire_peasant;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_nathanos";
    pNewScript->GetAI = &GetAI_npc_nathanos;
    pNewScript->pQuestAcceptNPC = &QuestAccept_npc_nathanos; //Alita
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_darrowshire_trigger";
    pNewScript->GetAI = &GetAI_npc_darrowshire_trigger;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_joseph_redpath";
    pNewScript->GetAI = &GetAI_npc_joseph_redpath;
    pNewScript->pGossipHello = &GossipHello_npc_joseph_redpath;
    pNewScript->RegisterSelf();

    //Alita
    pNewScript = new Script;
    pNewScript->Name = "npc_demetria";
    pNewScript->GetAI = &GetAI_npc_demetria;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "go_mark_of_detonation";
    pNewScript->pEffectDummyGameObj = &EffectDummyGameObj_go_mark_of_detonation;
    pNewScript->RegisterSelf();
}
